...
public class TestController {
	...
	public void testGetCallNegative() throws Exception {
		when(cardService.processPayment(Mockito.anyLong(), Mockito.anyDouble()))
				.thenThrow(new IllegalArgumentException("in test Call"));
		long cardnumber = 1234567890;
		Double amt = 5000.0;
		mockMvc.perform(get("/card/{cardNumber}/{charge}", cardnumber, amt))
